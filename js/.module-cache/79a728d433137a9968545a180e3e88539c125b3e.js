...
var Bulletin = React.createClass({displayName: "Bulletin",
	...
	getInitialState: function() {
		return {header: {}, itinerary: [], sermon: {}};
	},
	...
	render: function() {
		return (
			React.createElement("div", {className: "container text-center text-body h4"}, 
				...
				React.createElement(SermonNotes, {title: this.state.sermon.title, scripture: this.state.sermon.title})
			)
		);
	}
});
