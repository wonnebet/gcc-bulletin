...
var Itinerary = React.createClass({displayName: "Itinerary",
	...
	componentWillMount: function() {
		var firebaseRef = new Firebase(firebaseRoot + itinerary);
		this.bindAsArray(firebaseRef, "flavorLines");

		firebaseRef = new Firebase(firebaseRoot + scriptureKey);
		this.bindsAsObject(firebaseRef, "scripture");
	},
	...
	render: function() {
		...
		return (
			React.createElement("div", null, 
				...
				React.createElement(MainAction, {text: "Prayer"}), 
				React.createElement(MainAction, {text: "Offering"}), 
				React.createElement(MainAction, {text: "Communion"}), 
				scriptureLine, 
				React.createElement(MainAction, {text: "Sermon"}), 
				React.createElement(MainAction, {text: "Closing Remarks and Prayer"})
			)
		);
	}
});
