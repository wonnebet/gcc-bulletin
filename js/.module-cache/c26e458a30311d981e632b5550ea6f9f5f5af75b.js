...
var Bulletin = React.createClass({displayName: "Bulletin",
	...
	componentWillMount: function() {
		...
		this.bindAsObject(firebaseRef.child(frontKey).child(headerKey), headerKey);
		this.bindAsArray(firebaseRef.child(frontKey).child(itineraryKey), itineraryKey);
		this.bindAsObject(firebaseRef.child(frontKey).child(sermonKey), sermonKey);
	},
