	...
	render: function() {
		return (
			React.createElement("div", {className: "container text-center text-body h4"}, 
				...
				React.createElement(Header, {date: this.props.data.header.date, issue: this.props.header.issue}), 
				React.createElement(Itinerary, {items: this.props.itinerary}), 
				React.createElement("hr", null), 
				React.createElement(SermonNotes, {header: this.props.sermon.header, notes: this.props.sermon.notes}), 
